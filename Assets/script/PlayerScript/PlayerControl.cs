...
public class PlayerController : MonoBehaviour
{
    ...
    void GenerateBubble()
    {
        ...
        currentBubbleScript = currentBubble.GetComponent<RiseBubble>();
        if (currentBubbleScript == null)
        {
            currentBubbleScript = currentBubble.GetComponent<FallBubble>();
        }else if(currentBubbleScript == null)
        {
            currentBubbleScript = currentBubble.gameObject.AddComponent<BoomBubble>();
        }
        else if (currentBubbleScript == null)
        {
            currentBubbleScript = currentBubble.gameObject.AddComponent<AttachBubble>();
        }
